...
fig = ff.create_distplot([dice_list],["HEIGHT"],show_hist = False)
fig.show()
...
fig.add_trace(go.Scatter(x=[first_st_dev_start,first_st_dev_start],y=[0,0.2],mode="lines",name ="std_1"))

fig.add_trace(go.Scatter(x=[first_st_dev_end,first_st_dev_end],y=[0,0.2],mode="lines",name ="std_1"))



fig.add_trace(go.Scatter(x=[second_st_dev_start,second_st_dev_start],y=[0,0.2],mode="lines",name ="std_2"))

fig.add_trace(go.Scatter(x=[second_st_dev_end,second_st_dev_end],y=[0,0.2],mode="lines",name ="std_2"))



fig.add_trace(go.Scatter(x=[third_st_dev_start,third_st_dev_start],y=[0,0.2],mode="lines",name ="std_3"))

fig.add_trace(go.Scatter(x=[third_st_dev_end,third_st_dev_end],y=[0,0.2],mode="lines",name ="std_3"))
